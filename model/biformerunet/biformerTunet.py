...
class Unet(nn.Module):
    ...
    def forward(self, inputs):
        [feat1, feat2, feat3, feat4,feat5] = self.backbone(inputs)[0:]

        print(feat1.shape) #torch.Size([1, 64, 128, 128])
        print(feat2.shape) #torch.Size([1, 64, 64, 64])
        print(feat3.shape) #torch.Size([1, 128, 32, 32])
        print(feat4.shape) #torch.Size([1, 256, 16, 16])
        print(feat5.shape) #torch.Size([1, 512, 8, 8])
